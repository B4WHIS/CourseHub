...
function SearchContent() {
  ...
  // Reset về trang 1 khi đổi từ khóa, category hoặc cấp độ
  useEffect(() => {
    setCurrentPage(1);
  ...
  const filterCourses = () => {
    ...
    if (selectedLevel !== 'all') {
      filtered = filtered.filter((c: Course) => c.level === selectedLevel);
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4 mb-6 overflow-x-auto pb-2">
          <span className="text-sm font-medium text-gray-600 py-2 whitespace-nowrap">Cấp độ:</span>
          <button
